...
services. They may contain bugs. They may not be appropriate for your
environment.
---
...
If you're not comfortable doing the above, please don't run these scripts.
---
Usage
Open the folder for the script you're interested in and read its own
documentation/comments for prerequisites, parameters, and examples. Requirements
vary by script.
License / contributions
Use at your own risk, as described above. This is a personal repository; it may
